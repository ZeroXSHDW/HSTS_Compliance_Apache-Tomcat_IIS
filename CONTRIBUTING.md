...
- Update CODE_REVIEW.md if changing architecture
- Update EXECUTION_FLOW.md if changing flow
...
├── OWASP_COMPLIANCE.md    # OWASP compliance verification
├── .gitignore            # Git ignore patterns
├── tomcat_hsts.sh        # Tomcat HSTS script
├── iis_hsts.ps1          # IIS HSTS script
