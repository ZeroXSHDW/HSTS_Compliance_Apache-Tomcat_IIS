                ...
                function Test-HstsHeaders {
                    ...
                    try {
                        ...
                        if ($headerCount -eq 0) {
                            ...
                            Write-LogMessage "  Add HSTS header: Strict-Transport-Security: $RecommendedHsts"
                            Write-LogMessage ""
                            Write-LogMessage "To fix, run the configure command:"
                            Write-LogMessage "  .\Remote_UpdateIisHstsWin.ps1 -ServerName <server> -Mode configure -SecurityLevel $SecurityLevel"
                            Write-LogMessage ""
