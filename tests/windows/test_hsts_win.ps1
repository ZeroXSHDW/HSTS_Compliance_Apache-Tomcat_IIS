...
if ($IsWindows) {
    ...
    $LOG_FILE = "/tmp/TestHstsWin.log"
    $TEST_DIR = "/tmp/HstsTest"
    $BACKUP_DIR = "/tmp/HstsTestBackup"
}
...
$scriptPath = Join-Path $PSScriptRoot "..\..\src\windows\UpdateTomcatHstsWin.ps1"
...
$iisScriptPath = Join-Path $PSScriptRoot "..\..\src\windows\UpdateIisHstsWin.ps1"
