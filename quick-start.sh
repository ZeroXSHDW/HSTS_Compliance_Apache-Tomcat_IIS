...
if [ "$machine" == "Linux" ]; then
    ...
    if [ -f "./src/unix/Patch/bash/UpdateTomcatHstsUnix.sh" ]; then
    ...
    echo ".\src\windows\Patch\powershell\UpdateTomcatHstsWin.ps1 -Mode audit"
    echo ".\src\windows\Patch\powershell\UpdateIisHstsWin.ps1 -Mode audit"
else
